...
const STEPS = [
  {
    ...
    title: 'İlk gün: bir oyuncu seç',
    body: 'Bu tur tek kararın var: üç karttan birini kadroya al. Seçimden sonra maç otomatik oynanır.',
    highlight: 'Kartın üstündeki “Seçersen” kısmı sana oyuncunun ne değiştireceğini söyler.',
  },
  {
    id: 'synergy',
    round: 2,
    phase: 'cardSelect' as const,
    title: 'Stratejini buradan gör',
    body: 'Üstteki Sinerji ve Plan butonları detay ekranlarıdır. Ana ekranda kalabalık yapmaz; ihtiyacın olunca açarsın.',
    highlight: 'Sinerji, hangi tagleri toplarsan bonus açacağını gösterir.',
  },
  {
    id: 'match',
    round: 2,
    ...
    body: 'Maç bitince sağ panelde skor, moral değişimi, kazandığın puan ve sıradaki adım görünür.',
    highlight: 'Sonuç netleşince “Devam” ile yeni rounda geç.',
  },
  {
    id: 'event',
    round: 4,
