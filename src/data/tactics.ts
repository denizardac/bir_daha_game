...
const TACTIC_EFFECTS: Record<string, ActiveTactic> = {
  tactic_433_kontr: { id: 'tactic_433_kontr', name: '4-3-3 Geniş Oyun', description: 'Kanatlı hücum, arkada kontrollü risk', attackMod: 8, defenseMod: -5 },
  tactic_442: { id: 'tactic_442', name: '4-4-2 Klasik Denge', description: 'Güvenli ve stabil başlangıç', attackMod: 2, defenseMod: 2 },
  tactic_352: { id: 'tactic_352', name: '3-5-2 Yoğun Baskı', description: 'Merkez baskısı, kanat riski', attackMod: 11, defenseMod: -9 },
  tactic_532: { id: 'tactic_532', name: '5-3-2 Savunma Bloku', description: 'Derin blok, düşük üretim', defenseMod: 14, attackMod: -11 },
  tactic_4231: { id: 'tactic_4231', name: '4-2-3-1 Modern Oyun', description: 'Dengeli merkez bağlantısı', attackMod: 4, defenseMod: 1 },
  tactic_343: { id: 'tactic_343', name: '3-4-3 Tam Hücum', description: 'En patlayıcı hücum, ağır savunma riski', attackMod: 18, defenseMod: -15 },
  tactic_diamond: { id: 'tactic_diamond', name: '4-1-2-1-2 Elmas', description: 'Merkez oyunu, kanatsız yapı', attackMod: 4, defenseMod: 1 },
  tactic_4411: { id: 'tactic_4411', name: '4-4-1-1 İkinci Forvet', description: 'Kontrollü hücum riski', attackMod: 7, defenseMod: -5 },
  tactic_3412: { id: 'tactic_3412', name: '3-4-1-2 Çift Forvet', description: 'Agresif merkez hücumu', attackMod: 12, defenseMod: -10 },
  tactic_451: { id: 'tactic_451', name: '4-5-1 Yoğun Orta Saha', description: 'Kalabalık merkez, güvenli oyun', defenseMod: 12, attackMod: -9 },
  ...
  tactic_rotasyon: { id: 'tactic_rotasyon', name: 'Kadro Rotasyonu', description: 'Yorgunluk koruması ve geniş kadro', defenseMod: 2, moralePerMatch: 3, squadSizeBonus: 80, squadSizeThreshold: 10 },
  tactic_tekli_forvet: { id: 'tactic_tekli_forvet', name: 'Tek Forvet Sistemi', description: 'Bitirici santrafor şartı', perGoalBonus: 60 },
  tactic_catenaccio: { id: 'tactic_catenaccio', name: 'Alçak Blok (Catenaccio)', description: 'Gol yememe planı', attackMod: -5, defenseMod: 9, cleanSheetWinBonus: 220, cleanSheetDrawBonus: 100 },
  ...
  tactic_park_bus: { id: 'tactic_park_bus', name: 'Otobüsü Çek (Park the Bus)', description: 'Tam kapanma, temiz maç avı', defenseMod: 12, attackMod: -10, cleanSheetWinBonus: 260, cleanSheetDrawBonus: 120 },
